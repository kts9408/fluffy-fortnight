...
pushd ..\build
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% ..\src\FluffyFortnight.cpp -FmcFluffyFortnight.map /LD /link -incremental:no -opt:ref -PDB:FluffyFortnight_%random%.pdb /DLL -EXPORT:game_Render
