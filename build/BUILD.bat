...
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% ..\src\FluffyFortnight.cpp -FmFluffyFortnight.map /LD /link -incremental:no -opt:ref -PDB:FluffyFortnight-%random%.pdb /DLL -EXPORT:renderGame
